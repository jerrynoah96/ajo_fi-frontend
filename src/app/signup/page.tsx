...
export default function SignUp() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
      ...
      >
        <div>
          <h2 className="text-3xl font-bold text-center font-heading">Create Account</h2>
          <p className="text-center text-gray-600 mt-2">Join AjoFi and start your savings journey</p>
        </div>
