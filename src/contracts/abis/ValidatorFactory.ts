export const ValidatorFactoryABI = [
    {
      "inputs": [
        {
    ...
    },
    {
      ...
      "name": "ValidatorParameterUpdated",
      "type": "event"
    },
    {
      "inputs": [],
